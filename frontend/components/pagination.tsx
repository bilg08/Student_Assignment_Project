          ...
          <nav
            ...
            {makePageCountArray().map((pageCount) => (
              <a
                ...
                href="#"
                aria-current="page"
                className={`relative z-10 inline-flex items-center border border-indigo-500  ${pageCount === page ? "bg-indigo-500" : "bg-indigo-50"} bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-600 focus:z-20`}
>
                {pageCount}
              </a>
            ))}
