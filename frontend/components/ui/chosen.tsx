...
export const Chosen: React.FC<ChosenListProps> = ({ chosen, personalPosts,  }) => {
	...
	return (
            ...
            <div className="overscroll-y-none  flex-col flex items-center pb-[100px]">
              {personalPosts.map((el: { subject: any; detail: any; pendingRequest: any[]; worker: { id: any; email: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; }; }, ind: Key | null | undefined) => {
                return (
                  <ProfileCard key={ind}>
                    <PostReceived
                      name={el.subject}
